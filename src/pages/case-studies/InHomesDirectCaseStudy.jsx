      ...
      <Container className="py-3">
        <div className="flex items-center justify-between gap-3">
          <div className="hidden sm:flex items-center gap-2 text-xs text-zinc-300">
            <Layout className="h-4 w-4 text-[#1D4ED8]" />
              ...
              <Reveal>
                ...
                <div className="mt-7 flex flex-wrap gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#1D4ED8] to-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#1D4ED8]/35 hover:shadow-xl hover:shadow-[#1D4ED8]/55 transition-all hover:scale-[1.02]"
                  >
